...
@Intercepts(value = {
        ...
        @Signature(type = Executor.class, method = "get", args = {MappedStatement.class, Object.class, RowBounds.class, ResultHandler.class, CacheKey.class, BoundSql.class}),
